...
# Commentons l'import problématique
...
class AutoMasker:
    def __init__(
        ...
        # Créons des versions simplifiées pour éviter d'utiliser SCHP
        ...
        # Version simplifiée qui retourne une image noire
        self.schp_processor_atr = self._dummy_schp_processor
        self.schp_processor_lip = self._dummy_schp_processor
    ...
    def _dummy_schp_processor(self, image_or_path):
        """Version simplifiée qui retourne une image noire pour remplacer SCHP"""
